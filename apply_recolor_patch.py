...
edit("pc_port/settings/pc_settings.h", [
    ("/// Minutes of play per in-game day. 10 is the original.\n"
     ...
     "\n"
     "/// \"Custom\" palette (last entry in the cycle): live R/G/B per Piki slot,\n"
     "/// edited in the F1 / Mods menu. 0-255 each.\n"
     "int pc_settings_get_recolor_custom_blue_r(void);\n"
     "int pc_settings_get_recolor_custom_blue_g(void);\n"
     "int pc_settings_get_recolor_custom_blue_b(void);\n"
     "int pc_settings_get_recolor_custom_red_r(void);\n"
     "int pc_settings_get_recolor_custom_red_g(void);\n"
     "int pc_settings_get_recolor_custom_red_b(void);\n"
     "int pc_settings_get_recolor_custom_yellow_r(void);\n"
     "int pc_settings_get_recolor_custom_yellow_g(void);\n"
     "int pc_settings_get_recolor_custom_yellow_b(void);\n"),
])
